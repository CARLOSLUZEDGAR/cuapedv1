            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" @click="reporteIndividual(per_codigo)">
                            <i class="far fa-file-alt" aria-hidden="true">  REPORTE DESTINOS </i>
                        </button> &nbsp;
                        <button type="button" class="btn btn-primary btn-sm" @click="certificadoIndividual(per_codigo)">
                            <i class="far fa-file-alt" aria-hidden="true">  CERTIFICADO DESTINOS</i>
                        </button> &nbsp;
                    </div>
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <textarea name="textarea" class="form-control" rows="3" v-model="perdest_observaciones"></textarea>
                        </div>
                    </div>
            </div>
...
export default {
    ...
    validations:{
        ...
        perdest_nro_doc : { required, $autoDirty: true },
        perdest_tipo_doc : { required, $autoDirty: true },
        perdest_fechadestino : { required, $autoDirty: true },
        perdest_destn1_codigo : { required, $autoDirty: true },
        perdest_destn2_codigo : { required, $autoDirty: true },
        perdest_destn3_codigo : { required, $autoDirty: true },
        perdest_destn4_codigo : { required, $autoDirty: true },
        valor : { required, $autoDirty: true },

        perdest_nro_docA : { required, $autoDirty: true },
        perdest_tipo_docA : { required, $autoDirty: true },
        perdest_fechadestinoA : { required, $autoDirty: true },
        perdest_destn1_codigoA : { required, $autoDirty: true },
        perdest_destn2_codigoA : { required, $autoDirty: true },
        perdest_destn3_codigoA : { required, $autoDirty: true },
        perdest_destn4_codigoA : { required, $autoDirty: true },
        perdest_cargo1A : { required, $autoDirty: true },
    },
    ...
    methods: {
        ...
        listarCargos(){
            let me = this;
            this.filtro = this.arrayDatosPersonal.subescid;
            //me.filtro = me.arrayDatosPersonal.subescid;
            axios
            .get("/listarCargos", {
                filtro : 1,
            })
        ...
        /*listarCargos(){
            let me =this;
            var filtro = 'T';
            if (me.arrayDatosPersonal.subescid==1 || me.arrayDatosPersonal.subescid==2 || me.arrayDatosPersonal.subescid==3)
                {
                    filtro='O';
                }
                else if (me.arrayDatosPersonal.subescid==4 || me.arrayDatosPersonal.subescid==5 || me.arrayDatosPersonal.subescid==6)
                {
                    filtro='S';
                }
                else if (me.arrayDatosPersonal.subescid==21)
                {
                    filtro='M';
                }
                else if (me.arrayDatosPersonal.subescid==7 || me.arrayDatosPersonal.subescid==8 || me.arrayDatosPersonal.subescid==9 || me.arrayDatosPersonal.subescid==10 || me.arrayDatosPersonal.subescid==11 || me.arrayDatosPersonal.subescid==12)
                {
                    filtro='C';
                }
            else{
       ...
       obtenerPromocion(){
        ...
        reporteIndividual(per_codigo){
          window.open('http://127.0.0.1:8000/reporteIndividual?per_codigo='+per_codigo);
        },
        
        certificadoIndividual(per_codigo){
          window.open('http://127.0.0.1:8000/certificadoIndividual?per_codigo='+per_codigo);
        },
    },
}
</script>